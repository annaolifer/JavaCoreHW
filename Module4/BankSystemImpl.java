...
// methods with printing to console
    ...
    public void withdrawOfUser(User user, int amount) {
        System.out.println(user + "Amount of withdrawal: " + amount);
    }

    public void fundUser(User user, int amount) {
        System.out.println(user + "Amount of funding: " + amount);
    }

    public void transferMoney(User fromUser, User toUser, int amount) {
        System.out.println("Money transfer from " + fromUser + "to " + toUser + "Amount of transfer: " + amount);
    }

    public void paySalary(User user) {
        System.out.println("Salary payed to " + user);
    }

}

// Methods with calculations which return values
